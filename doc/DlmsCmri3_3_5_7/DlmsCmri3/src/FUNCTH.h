...
#define METER_TYPE_A					1
#define METER_TYPE_B					2
#define METER_TYPE_C					3

#define USER_CHOISE_NONE				0
#define USER_CHOISE_VIEW_MODE			1
#define USER_CHOISE_DOWNLOAD_MODE		2
#define USER_CHOISE_UPLOAD_MODE			3
#define USER_CHOISE_PROGRAM_MODE		4
#define USER_CHOISE_AUTHENTICATION		5
#define USER_CHOISE_TEST_MODE			6
#define USER_CHOICE_NAME_PLATE_DETAILS	7
#define USER_CHOICE_DOWNLOAD_STATUS		8

#define PC_ASSOCIATION 			0x21
#define MR_ASSOCIATION			0x41
#define US_ASSOCIATION			0x61
int NoOfMeter(void);
typedef enum 
{
	METER_RTC_SETTING = 1,
...
int Disconnect(void);		//disconnect from Meter
...
int GetRequestFile(unsigned char classID, unsigned char Obis_a, unsigned char Obis_b, unsigned char Obis_c, unsigned char Obis_d, unsigned char Obis_e,unsigned char Obis_f,unsigned char Attr);
...
void commPort(unsigned int a_Port);
...
int MainScr(void);
void sys_Time(unsigned char Line);
int  Read_Serial_No(void);
int LLSscr(void);
int SANDS (void);
int Authentication(void);
int View_Mode(void);
int ViewRequest(unsigned char classID,unsigned char Obis_a,unsigned char Obis_b,unsigned char Obis_c,unsigned char Obis_d,unsigned char Obis_e,unsigned char Obis_f,unsigned char Attr);
